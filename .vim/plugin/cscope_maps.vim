...
if has("cscope")
    ...
    nmap <F4>s :vert scs find s <C-R>=expand("<cword>")<CR><CR>
    nmap <F4>g :vert scs find g <C-R>=expand("<cword>")<CR><CR>
    nmap <F4>c :vert scs find c <C-R>=expand("<cword>")<CR><CR>
    nmap <F4>t :vert scs find t <C-R>=expand("<cword>")<CR><CR>
    nmap <F4>e :vert scs find e <C-R>=expand("<cword>")<CR><CR>
    nmap <F4>f :vert scs find f <C-R>=expand("<cfile>")<CR><CR>	
    nmap <F4>i :vert scs find i ^<C-R>=expand("<cfile>")<CR>$<CR>	
    nmap <F4>d :vert scs find d <C-R>=expand("<cword>")<CR><CR>
